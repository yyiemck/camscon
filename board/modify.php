...
<body>
	...
	<div class="container">
		...
		<div class="col-md-9">
			<ul class="nav nav-pills">
				<?php
					if(!isset($_POST['myread'])) {?>
						<li role="presentation" class="backtotheread"><a href="board1.php?board=1">게시판1</a></li>
						<li role="presentation" class="backtotheread"><a href="board1.php?board=2">게시판2</a></li>
						<li role="presentation" class="backtotheread"><a href="board1.php?board=3">게시판3</a></li>
						<li role="presentation" class="backtotheread"><a href="board1.php">전체 게시판</a></li><?php
					}
					else { ?>
						<li role="presentation" class="backtotheread"><a href="myboard.php?board=1">게시판1</a></li>
						<li role="presentation" class="backtotheread"><a href="myboard.php?board=2">게시판2</a></li>
						<li role="presentation" class="backtotheread"><a href="myboard.php?board=3">게시판3</a></li>
						<li role="presentation" class="backtotheread"><a href="myboard.php">전체 게시판</a></li><?php
					}
				?>
			</ul>
				...
				<table class="table1 table table-bordered">
					...
					<tr>
						<td colspan="4" style="text-align:center">
							...
							<button class="btn btn-default toRead" type="button">뒤로</button>
						</td>
					</tr>
				</table>
				<input type="hidden" name="ind" value=<?php echo $boardArray[0][0]?>/>
				<input type="hidden" name="writetime" value=<?php echo $boardArray[0][5]?>/>
	...
	<script type="text/javascript">
		...
		var tapselect = document.getElementsByClassName('backtotheread');
		if(<?php echo $_REQUEST['req']?>==2) {
			tapselect[1].className="active";
		} 
		else if(<?php echo $_REQUEST['req']?>==3) {
			tapselect[2].className="active";
		}
		else {
			if(<?php echo $_REQUEST['req']?>==1) {
				tapselect[0].className="active";	
			}
			else {
				tapselect[3].className="active";
			}
		}
		document.getElementsByClassName('toRead')[0].addEventListener("click", function() {history.back(-1);});
	</script>
</body>
</html>