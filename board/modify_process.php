...
<?php
	...
	if($_POST['title']=="") {
		...
		if(isset($_SESSION['nickname']) && isset($_POST['passwd']) && isset($_POST['title']) && isset($_POST['content'])) {
			$sqlConn->queryUpdateBoard('password', $_POST['passwd'], 'index', $_POST['ind']);
			$sqlConn->queryUpdateBoard('title', $_POST['title'], 'index', $_POST['ind']); 
			$sqlConn->queryUpdateBoard('content', $_POST['content'], 'index', $_POST['ind']); 
			$sqlConn->queryUpdateBoard('modifytime', $updateTime, 'index', $_POST['ind']); 
			echo '<script type="text/javascript">';
