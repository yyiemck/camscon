...
if($_POST['comment_mod_ta']==""){
	...
	if(isset($_SESSION['nickname']) && isset($_POST['comment_mod_ta']) && isset($_POST['modChecker'])){
		$sqlLink->queryUpdateComment('content_comm', $_POST['comment_mod_ta'], 'index_comm', $_POST['modChecker']); 
		$sqlLink->queryUpdateComment('m_time_comm', $updateTime, 'index_comm', $_POST['modChecker']); 
		echo '<script type="text/javascript">';
