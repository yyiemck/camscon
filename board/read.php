...
<body>
	...
	<div class="container">
		...
		<div class="col-md-9">
			...
			<!-- READ part HEAD END -->
			<!-- READ part BODY START --> 
			<div class="content_container">
				<p class="content">
				<?php 
					echo "<script type='text/javascript'>";
					$boardArray[0][4] = nl2br($boardArray[0][4]);
					echo "</script>";
					echo $boardArray[0][4]
				?>
				</p>
			...
			<div class="button_container">
				...
				<button class="btn btn-default toBoard" type="button" onclick="history.back(-1)">뒤로</button>
			</div>
			<!-- READ part BODY END -->
			...
			<div class="comm_write">
				...
				<div style="display:inline-block">
					<form name="form4" method="POST" action="./comment.php">
						<div class="comm_write_content"><textarea class="form-control" cols="74" rows="4" style="font-size:14px" name="content_c"></textarea></div>
	...
	<script type="text/javascript">
		...
		// EVENT LISTENERS
		document.getElementsByClassName('board_write')[0].addEventListener("click", function() {location.href="write.php?req=<?php echo $boardArray[0][8]?>"});
